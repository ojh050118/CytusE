...
namespace CytusE.Game.Gameplay.Scoring
{
    ...
    public class HitWindows
    {
        ...
        {
            new DifficultyRange(HitResult.TPPerfect, 22.4D, 19.4D, 13.9D),
            new DifficultyRange(HitResult.Perfect, 64, 49, 34),
        ...
        {
            for (var result = HitResult.Good; result <= HitResult.TPPerfect; ++result)
            {
        ...
        public class EmptyHitWindows : HitWindows
        {
            ...
            {
                new DifficultyRange(HitResult.TPPerfect, 0, 0, 0),
