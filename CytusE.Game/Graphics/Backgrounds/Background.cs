...
namespace CytusE.Game.Graphics.Backgrounds
{
    /// <summary>
    /// A background which offers blurring via a <see cref="BufferedContainer"/> on demand.
    /// Original Source: https://github.com/ppy/osu/blob/master/osu.Game/Graphics/Backgrounds/Background.cs
    /// </summary>
    public class Background : CompositeDrawable, IEquatable<Background>
    {
        ...
        {
            Sprite.Texture = !string.IsNullOrEmpty(textureName) ? textures.Get(textureName) : texture;
        }
